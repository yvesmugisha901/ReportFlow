...
// SVG icon library — accepts either a string key or a ReactNode passthrough
...
const ICONS = {
    ...
    // reviewer / approver dashboard icons
...
function resolveIcon(icon) {
    if (!icon) return null;
    // string key → look up SVG
    if (typeof icon === "string") return ICONS[icon] ?? null;
    // ReactNode (emoji string, JSX) → render as-is
    return icon;
}
