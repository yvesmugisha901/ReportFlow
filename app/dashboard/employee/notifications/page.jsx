...
const Icon = ({ name, className = "w-4 h-4" }) => {
    ...
    const icons = {
        ...
        spinner: <svg {...base} className={`${className} animate-spin`}><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>,
    };
                    ...
                    <div className="flex items-center gap-2">
                        {hasRead && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-red-200 rounded-xl text-sm font-semibold text-red-500 hover:bg-red-50 transition-colors disabled:opacity-50"
                            >
                                <Icon name={clearingRead ? "spinner" : "trash"} className="w-3.5 h-3.5" />
                        ...
                        {notifications.map(n => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <Icon
                                            name={deletingId === nid ? "spinner" : "close"}
